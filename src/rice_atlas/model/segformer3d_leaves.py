...
class SegFormer3D_leaves(nn.Module):
    def __init__(
        self,
        in_channels: int = 1,
    ...
    def forward(self, x):
        ...
        #print(f"After encoder: {x[0].shape}, {x[1].shape}, {x[2].shape}, {x[3].shape}")
...
class PatchEmbedding(nn.Module):
    ...
    def forward(self, x):
        ...
        #print(f"PatchEmbedding output shape: {patches.shape}")
...
if __name__ == "__main__":
    ...
    segformer3D = SegFormer3D_leaves().to("cuda:0")
